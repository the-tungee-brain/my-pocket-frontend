...
import { appGapClass, appMainClass, appSplitClass, appStackClass } from "@/lib/appUi";
...
export const pageOverviewSplitClass =
  `grid ${appGapClass} w-full grid-cols-1 [&>*]:min-w-0 [&>*]:w-full xl:grid-cols-[minmax(0,1.62fr)_minmax(260px,1fr)] xl:items-start`;
...
export const pageOverviewAsideClass =
  `min-w-0 w-full max-w-none lg:max-w-none ${appStackClass} [&>*]:w-full`;

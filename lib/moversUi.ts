...
export const moversMetaTitleClass =
...
export const moversDetailEmptyClass =
  "app-panel flex min-h-[320px] flex-col items-center justify-center px-6 py-12 text-center";

export const moversDetailAsideStickyClass = "lg:sticky lg:top-4";

export const moversSectionHeadingClass =
  "text-[10px] font-semibold uppercase tracking-[0.14em] text-muted";
...
export const moversRankedRowSelectedClass = "bg-accent-muted/40";

export const moversRankedRowHoverClass = "hover:bg-muted-bg/50";

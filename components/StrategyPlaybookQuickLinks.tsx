...
export function StrategyPlaybookQuickLinks() {
  ...
  return (
    <section className="mb-6 rounded-2xl border border-border bg-muted-bg/40 p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <Link
          href="/portfolio"
          className="inline-flex items-center gap-1 rounded-full bg-muted-bg px-2.5 py-1 text-[11px] font-medium text-foreground transition hover:bg-secondary"
        >
          Open playbook
        ...
        {symbols.map((symbol) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "inline-flex min-w-0 flex-col rounded-xl border border-border bg-muted-bg/30 px-3 py-2 transition hover:bg-muted-bg/60",

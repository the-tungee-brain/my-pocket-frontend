...
export function TaxWashSaleStrip({ items, onRun, className }: Props) {
  ...
  return (
    <section
      className={cn(
        "mx-auto w-full overflow-hidden border border-amber-500/30 bg-amber-500/5 shadow-sm",
        className,
      )}
      aria-label="Tax and wash-sale alerts"
    >
      <div className="flex items-start gap-3 border-b border-amber-500/20 px-4 py-3">
        <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center bg-amber-500/15 text-amber-800 dark:text-amber-200">

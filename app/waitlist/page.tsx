...
export default function WaitlistPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-4.5rem)] max-w-lg items-center px-4 py-12">
        <div className="w-full rounded-2xl border border-border bg-secondary/60 p-8 shadow-sm">

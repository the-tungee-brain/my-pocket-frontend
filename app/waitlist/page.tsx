  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-130 w-180 -translate-x-1/2 bg-accent/8 blur-3xl" />
      </div>
      ...
      >
        <div className={cn(pageContentClass, "w-full")}>
          <div className="border border-border bg-secondary/60 p-6 shadow-sm sm:p-8">
            <div className="mb-5 flex h-12 w-12 items-center justify-center bg-accent-muted text-accent-strong">
            ...
            <div className="mt-6 space-y-3 border border-border/80 bg-background/50 px-4 py-3 text-sm text-muted">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/"
                className="inline-flex h-9 items-center justify-center border border-border bg-background px-3 text-sm font-semibold transition-colors hover:bg-muted-bg hover:text-foreground"
              >
                Back to home
              </Link>
            </div>
